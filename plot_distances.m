...
%}
csvFile1 = 'cmake-build-debug\distances_pf0001_N141120_w210_95_1g.csv'; % Your CSV file
data2 = csvread(csvFile1);
...
data2 = csvread(csvFile1);
plot(data2(5:end,1),data2(5:end,2),LineWidth=2);
csvFile1 = 'cmake-build-debug\distances_pfT_N141120_w210_99_02g.csv'; % Your CSV file
data2 = csvread(csvFile1);
plot(data2(5:end,1),data2(5:end,2),LineWidth=2);
csvFile1 = 'cmake-build-debug\distances_LJG_N141120_w210_99_02g.csv'; % Your CSV file
data2 = csvread(csvFile1);
plot(data2(5:end,1),data2(5:end,2),LineWidth=2);
%legend(".7,2",".95,2",'.95,1',".95,1,P",Location="best")
legend(".0001",".01","90, .01","90, .01, .2g",'.99 LJG',Location="best");
